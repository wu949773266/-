  ...
  return (
    <ScrollView scrollY className="detail-page">
      ...
      <View className="content-section">
        <View
          className={`info-card card-fade-in-1 ${expandedSection.schedule ? 'expanded' : ''}`}
        ...
        {/* 费用说明 */}
        <View
          className={`info-card card-fade-in-2 ${expandedSection.price ? 'expanded' : ''}`}
        ...
        {/* 装备清单 */}
        <View
          className={`info-card card-fade-in-3 ${expandedSection.gear ? 'expanded' : ''}`}
